        ...
        <div class="row">
            ...
            <div class="inhalt col-md-7 col-lg-7">
                ...
                <p class="bold">
                    ...
                    Auf unserem Server werden keine Schülernamen gespeichert, sondern nur IDs. Die Schülervertretung besitzt die Zuweisung von ID zu Name.
                    Wenn eine Beschwerde bei uns eingeht, leiten wir diese, sofern das besagte Feedback gegen unsere <a href="/richtlinien">Richtlinien</a>
                    (in einem Satz zusammengefasst: „schreibe dein Feedback respektvoll“) verstößt, an die Schülervertretung weiter. Diese entscheidet dann, wie schwerwiegend der Verstoß war.
                    Geringe Verstöße führen zu einer Löschung des Accounts. Bei schweren Verstößen geben wir die ID des Feedbackgebenden an die Schülervertretung weiter.
                    Diese kann dann den Namen des Schülers dem entsprechenden Lehrer sagen. Disziplinäre Konsequenzen durch die Schulleitung und die Abteilungsleitung können folgen.</p>
            </div>
        </div>
        <div class="row">
